...
public class PautaApplicationService implements PautaService {
    ...
    public Pauta buscaPautaPorId(UUID idPauta) {
        log.info("[inicia] PautaApplicationService - buscaPautaPorId");
        Pauta pauta = pautaRepository.buscaPautaPorId(idPauta);
        log.info("[finaliza] PautaApplicationService - buscaPautaPorId");
        return pauta;
    }
}
